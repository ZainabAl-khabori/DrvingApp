...
import worldontheotherside.wordpress.com.drvingapp.TrainerProfileActivity;

/**
 * Created by u106543 on 12/9/2017.
 */
...
public class FirebaseApplication extends Application {
    ...
    public void checkUserLogin(final Context context){
        if(firebaseAuth.getCurrentUser() != null){
            Intent profileIntent = new Intent(context, TrainerProfileActivity.class);
                ...
                .addOnCompleteListener((Activity)context, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (!task.isSuccessful()) {
                            ...
                            AppKeys.displayMessageToast(context, "User has been login");
                            Intent profileIntent = new Intent(context, TrainerProfileActivity.class);
                            context.startActivity(profileIntent);
                        }
                    }
